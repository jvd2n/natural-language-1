...
'''
살인/강도/강간/절도/폭력 발생 & 검거

문제정의 1
서울시의 범죄현황과 CCTV현황을 분석해서
정해진 예산 안에서 구별로 다음 해에 배분하는 기준을 마련하시오.
예산 금액을 입력하면 구마다 할당되는 CCTV 카운터를 자동으로
알려주는 AI 프로그램을 작성하시오.
'''


class CctvServices(Reader):
    ...
    def save_folium_map(self):
        # data/kr-states.json
        # data/crime_in_seoul.csv -> crime
        # saved_data/police_norm.csv
        ...
        state_unemployment = f"./data/us_unemployment.csv"
